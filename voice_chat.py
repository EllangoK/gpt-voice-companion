...
if __name__ == '__main__':
    ...
    parser.add_argument('--openai_key', help='Your OpenAI API key.', default=None)
    parser.add_argument('--elevenlabs_key', help='Your elevenlabs.io API key.', default=None)
    ...
    parser.add_argument('--voice_recognition', help='Enable voice input', default=True)
